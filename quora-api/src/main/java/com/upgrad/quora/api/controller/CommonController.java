...
public class CommonController {
    ...
    @Autowired
    private CommonBusinessService userProfileService;  //instantiating the class with business logic for view user profile functionality
    ...
    public UserEntity viewUserProfile(@PathVariable("userId") final String userUuid,  @RequestHeader("authorization") final String authorization) throws AuthorizationFailedException, UserNotFoundException {
        return userProfileService.viewUserProfile(userUuid, authorization);
    }
}
